...
args = [
    ...
    Args(name='gpt2_residual_n_24_50', family="gpt2_residual_n", n_loop_window=24, epochs=50),
    Args(name='gpt2_residual_n_12_100', family="gpt2_residual_n", n_loop_window=12, epochs=100),
    Args(name='gpt2_residual_n_48_25', family="gpt2_residual_n", n_loop_window=48, epochs=25),
